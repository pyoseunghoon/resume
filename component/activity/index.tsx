...
type Payload = IActivity.Payload;
type Item = IActivity.Item;

export const Activity = {
  Component: ({ payload }: PropsWithChildren<{ payload: Payload }>) => {
    return PreProcessingComponent<IActivity.Payload>({
      payload,
      component: Component,
    });
  },
...
function Component({ payload }: PropsWithChildren<{ payload: Payload }>) {
  return (
    <CommonSection title="ACTIVITY">
      <ActivityRow payload={payload} />
    </CommonSection>
  );
}

function ActivityRow({ payload }: PropsWithChildren<{ payload: Payload }>) {
  return (
    <EmptyRowCol>
